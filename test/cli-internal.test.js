...
describe('goose-rarity internal helpers', () => {
  ...
  it('builds API URLs while omitting undefined params', () => {
    const url = __buildUrl('shows.json', { limit: 5, offset: undefined, year: 2024 });
    expect(url.toString()).toBe('https://elgoose.net/api/v2/shows.json?limit=5&year=2024');
  ...
  it('parses show dates and guards against invalid input', () => {
    expect(__parseShowDate('2024-05-10')?.toISOString()).toBe('2024-05-10T00:00:00.000Z');
